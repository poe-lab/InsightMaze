...
const int SYRINGE_0_STEP_PIN = 13;
const int SYRINGE_0_DIR_PIN = 12;
const int SYRINGE_1_STEP_PIN = 8;
const int SYRINGE_1_DIR_PIN = 7;
const int SYRINGE_2_STEP_PIN = 4;
const int SYRINGE_2_DIR_PIN = 2;
